...
class deleteTrack():
    ...
    def remove_Song(self):
        ...
        print("\t------------------------------------------------------------------------------------------------------\n")
        with open('/home/hduser/localrepo/kivy/hive/CPE106L/Project/FinalProj/BL/MUSIC-DATASET.csv', 'r', encoding="Latin-1") as readFile:
        ...
        with open('/home/hduser/localrepo/kivy/hive/CPE106L/Project/FinalProj/BL/MUSIC-DATASET.csv', 'w', newline='', encoding="Latin-1") as writeFile:
